...
const navigate = useNavigate();
    ...
    return (
      <div className="Prologue no-scroll">
        <Navbar expand="lg">
            <Container>
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="me-auto">
                    ...
                    <Nav.Link href="" className={activeLink === 'projects' ? 'active navbar-link' : 'navbar-link'} onClick={() => navigate('/repereschrono')}>Chapitre suivant</Nav.Link>
                </Nav>
            </Navbar.Collapse>
            </Container>
        </Navbar>
