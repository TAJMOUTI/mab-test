        ...
        <Navbar expand="lg">
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="me-auto">
                    ...
                    <Nav.Link href="" className={activeLink === 'skills' ? 'active navbar-link' : 'navbar-link'} onClick={() => navigate('/chapitre4sc1parta')}>Chapitre précédent</Nav.Link>
                    <Nav.Link href="" className={activeLink === 'projects' ? 'active navbar-link' : 'navbar-link'} onClick={() => navigate('/chapitre4sc2parta')}>Chapitre suivant</Nav.Link>
                </Nav>
            </Navbar.Collapse>
            </Container>
        </Navbar>
          <div className="PDF-viewer-container">
			      <PDFViewerComponent
				      document={"chapitre4sc1partb.pdf"}
			      />
		    </div>
      </div>
    );
