        ...
        <Navbar expand="lg">
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="me-auto">
                    ...
                    <Nav.Link href="" className={activeLink === 'skills' ? 'active navbar-link' : 'navbar-link'} onClick={() => navigate('/chapitre4sc3partd')}>Chapitre précédent</Nav.Link>
                    <Nav.Link href="" className={activeLink === 'projects' ? 'active navbar-link' : 'navbar-link'} onClick={() => navigate('/chapitre4sc3partf')}>Chapitre suivant</Nav.Link>
                </Nav>
            </Navbar.Collapse>
            </Container>
        </Navbar>
          <div className="PDF-viewer-container">
			      <PDFViewerComponent
				      document={"chapitre4sc3parte.pdf"}
			      />
		    </div>
      </div>
    );
