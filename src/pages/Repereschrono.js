...
const Repereschrono = () => {
  ...
  const onUpdateActiveLink = (value) => {
    ...
    return (
      <div className="Repereschrono no-scroll">
        <Navbar expand="lg">
            <Container>
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="me-auto">
                    ...
                    <Nav.Link href="" className={activeLink === 'skills' ? 'active navbar-link' : 'navbar-link'} onClick={() => navigate('/prologue')}>Chapitre précédent</Nav.Link>
                    <Nav.Link href="" className={activeLink === 'projects' ? 'active navbar-link' : 'navbar-link'} onClick={() => navigate('/chapitre1parta')}>Chapitre suivant</Nav.Link>
                </Nav>
            </Navbar.Collapse>
            </Container>
        </Navbar>
          <div className="PDF-viewer-container">
			      <PDFViewerComponent
				      document={"repereschrono.pdf"}
			      />
		    </div>
      </div>
    );
  };
export default Repereschrono;
